package com.github.mathlon26.ribble.io.input.devices;
...
public enum KeyBoardKey {
    ...
    public static final int MAX_KEYS = 350;
    ...
    public static KeyBoardKey fromCode(int code) {
        ...
        ExceptionHandler.raise(IllegalArgumentException.class, "Unknown key code: " + code);
